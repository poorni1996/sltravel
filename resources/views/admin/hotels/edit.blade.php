...
<div class="card card-primary card-outline">
    ...
    <form method="POST" action="{{ route('hotels.update') }}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea name="address" class="form-control" id="address"
                            rows="1">{{ old('price', $hotel->address) }}</textarea>
                        @error('address')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="price_child" value="{{ old('price_child', $hotel->price_child) }}">
                        @error('price_child')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2bs4" id="city_id" name="city_id">
                            ...
                            <option value="{{ $city->id }}" @if(old('city_id', $hotel->city_id) == $city->id) selected
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="telephone"
                            value="{{ old('telephone', $telephones->telephone) }}">
                        @error('telephone')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <input type="hidden" name="latitude" id="loca_lat" value="{{ old('latitude', $hotel->latitude) }}">
                    <input type="hidden" name="longitude" id="loca_lng"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <input type="checkbox" name="feature[{{ $hotel_feature->id }}]"
                                    id="feature_{{ $hotel_feature->id }}" value="1" @if(in_array($hotel_feature->id,
                                $features)) checked @endif>
